...
schemaJson = "struct<dni:string,full_name:string,phone_number:string,email:string,preference:string,password:string>"

checkpoint_path = "/FileStore/streaming/checkpoint/taller01/kafka/accounts"
...
dfAccounts
    ...
    .toTable("dtw_avengers_lakehouse.bronze_dev.accounts_brz")
)
