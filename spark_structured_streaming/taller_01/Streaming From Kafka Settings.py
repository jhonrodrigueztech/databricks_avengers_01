...
schemaJson = "struct<dni:string,color_background:string,photo:string,letter_size:string,avatar_name:string>"

checkpoint_path = "/FileStore/streaming/checkpoint/taller01/kafka/settings"
...
dfAccounts
    ...
    .toTable("dtw_avengers_lakehouse.bronze_dev.settings_brz")
)
